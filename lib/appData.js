module.exports = function(){
	...
	return {
		...
		makeSub: function(data){
			var p;
			if(data.team === 'home'){
				p = new Player(homeTeam[data.p2].id ,homeTeam[data.p1].number ,homeTeam[data.p1].name,
				...
				if(data.time === 0){
					p.takenDown = false;
					p.takenDownTime = 0;
					homeTeam[data.p2].takenUpTime = 0;
				}else{
					p.takenDownTime = data.time;
					homeTeam[data.p2].takenUpTime = data.time;
				}
				...
				p = new Player(awayTeam[data.p2].id ,awayTeam[data.p1].number ,awayTeam[data.p1].name,
				...
				if(data.time === 0){
					p.takenDown = false;
					p.takenDownTime = 0;
					awayTeam[data.p2].takenUpTime = 0;
				}else{
					p.takenDownTime = data.time;
					awayTeam[data.p2].takenUpTime = data.time;
				}
